           ...
           <div className="specPage">
            ...
            <Container fluid>
                ...
                <div className="define-random">
                    ...
                    <div>The frontend and backend are deployed in separate pipelines. The backend is hosted on Heroku, the frontend is hosted using Github pages. You can find their relevant code here:</div>
                    <div>Frontend: https://github.com/thomas-hoversen/funbanners-client</div>
                    <div>Backend: https://github.com/thomas-hoversen/funbanners-server</div><br></br>

                    <div>The frontend is a React app and the backend is a Spring Boot application. This site does not use any databases.</div><br></br>
                    <HR ></HR><br></br>
                    ...
                    <div>This app has 2 core flaws. First, it uses a ton of heap space and memory to generate new images, often more memory than Heroku pods allow on their free tier. The BufferedImage data structure quickly builds up in memory, and this app uses a lot of them. 
                        ...
                        I'm comfortable putting my name on it despite its poor memory allocation and the major limitations that imposes, especially it seems for mobile users. For desktop users, this app will currently handle up to 5MB of pictures, although 3 is better.<br></br><br></br>
                        The second flaw is that this app returns the generated images 
                        as base64 strings which the frontend decodes both for displaying the result as well as downloading the result. I learned when I first deployed this to the web and accessed it on my phone that some browsers will not decode base64. It seems that most desktop browsers do, and again, this was for fun, so I'm comfortable leaving this alone for now. 
                    </div><br></br>

                    <div>
                        While these are important issues that would not fly in production code, I view this project more as a MVP or proof of concept rather than a final product. If you would like to use this app, desktop yields best results. If you enjoy this service and or want to share feedback please send an email to funbanners2021@gmail.com. Thanks!
                    </div>
